...
import MACROPORTRAIT from "../../assets/macro-coaching.jpg";
...
const Macros = () => {
  return (
    <section id="macros">
      ...
      <div className="container macros__container">
        <div className="row align-items-center justify-content-evenly mt-5">
          <div className="order-2 order-lg-1 col-10 col-lg-6 mt-5 mt-lg-0 macros__list">
          ...
          <div className="order-1 order-lg-2 col-10 col-lg-4 macros__portrait">
            <img
              className="img-fluid mx-auto macros__portrait--image"
              src={MACROPORTRAIT}
              alt="Portrait of Nicole Kruse"
            />
          </div>
        </div>
      </div>
